  ...
  return (
    <div className="flex items-center bg-blue10 p-8 rounded-custom3 shadow-lg mx-4 md:mx-8 lg:mx-16">
      <div className="mr-8 text-left">
        <h2 className="text-3xl font-bold mb-4">How to Find a Shop and their offers at SpotBiz?</h2>
        <p className="text-lg mb-6">
          Discover a variety of shops and their exclusive offers on SpotBiz. 
          Here's how you can find them:
        </p>
        <ul className="list-disc list-inside text-lg space-y-2">
          <li>Go to SpotBiz website or download the SpotBiz mobile app</li>
