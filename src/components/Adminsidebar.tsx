...
const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    href: "/admin/business_verify",
    current: false,
    ico: <BusinessCenterIcon />,
    label: <span className="ms-3">Business Verification</span>,
  },
  {
    name: "Business Types & Tags",
    href: "/admin/categories_tags",
    current: false,
    ico: <StyleIcon />,
...
function Adminsidebar({ selectedTile }: AdminsidebarProps) {
  return (
    <aside
      id="logo-sidebar"
      className={`fixed top-0 left-0 w-64 h-screen pt-20 transition-transform translate-x-0 bg-white border-r border-gray-200 sm:translate-x-0`}
      aria-label="Sidebar"
    >
            ...
            <li key={item.name}>
              <a
                ...
                className={classNames(
                  selectedTile === item.name
                    ? "bg-gray-900 text-gray-100"
                    : "text-gray-900 hover:bg-gray-500 hover:text-gray-100",
