...
const RecommendationBox: React.FC = () => {
  return (
    <div className="max-w-xs bg-blue10 rounded-custom shadow-lg overflow-hidden">
      ...
      <div className="p-4">
        ...
        <div className="flex flex-wrap gap-2">
          <span className="bg-blue-100 text-primary text-sm font-semibold px-2 py-1 rounded">electronics</span>
          <span className="bg-blue-100 text-primary text-sm font-semibold px-2 py-1 rounded">computer</span>
        </div>
      </div>
    </div>
  );
