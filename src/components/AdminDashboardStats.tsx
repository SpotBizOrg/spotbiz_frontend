interface AdminDashboardSatsProps{
...
const AdminDashboardSats: React.FC<AdminDashboardSatsProps> = ({ customerCount, businessCount, totalRevenue }) => {
    return(
        <div className="flex flex-row gap-4">
            <div className="bg-white p-8 basis-1/3 rounded shadow-lg shadow-grey text-center flex-col w-full sm:w-60 md:w-80 lg:w-96 flex  justify-center">
                ...
                <div className="text-3xl font-bold">{businessCount}</div>
