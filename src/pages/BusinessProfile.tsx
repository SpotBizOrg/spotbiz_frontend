...
import { FaEdit, FaMapMarkerAlt, FaCamera, FaEye, FaEyeSlash, FaStar } from 'react-icons/fa';

const BusinessProfile: React.FC = () => {
  const [activeTab, setActiveTab] = useState('About Business');
  ...
  <div className="mt-4 space-y-6">
    <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <h3 className="text-lg font-bold">Business Owner Details</h3>
